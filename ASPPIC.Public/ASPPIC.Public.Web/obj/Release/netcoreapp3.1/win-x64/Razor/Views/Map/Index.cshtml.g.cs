#pragma checksum "D:\Projects\ASPPIC-19\asppic-19-public\ASPPIC.Public\ASPPIC.Public.Web\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ed47adf3ee7069f531ba4374a0ad04b9a7c40491"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ed47adf3ee7069f531ba4374a0ad04b9a7c40491", @"/Views/Map/Index.cshtml")]
...
");
    ...
    <script>
        ...
        function style_asppic19(feature) {
            return {
                fillColor");
                WriteLiteral(@": getColor(feature.properties['last_day']),
                weight: 2,
                opacity: 1,
                color: 'white',
                dashArray: '3',
 ...
 ");
        ...
        hospitals.bindPopup(function (layer) {
            return L.Util.template(`<h5><strong>{HospitalName}</strong> ({Abbreviation}) </h5>                
                ...
                <p><strong>Website: </strong><a href=""{Fu");
                WriteLiteral(@"llLink}"" target=""_blank"">{FullLink}</a></p>
        ...
        legend.onAdd = function (map) {
           ...
           ");
                WriteLiteral(@"         else if (grades[i] === ""Centru de Testare COVID"")
                  ...
                  ");
                WriteLiteral(@"      div.innerHTML += '<img src=""images/marker-icon-green.png""/> ' + grades[i] + '<br>';                    
                    else
